...
import { ARCHER_RELAY_URI } from '../config/constants/archer'
...
export function useSwapCallArguments(
    ...
    const factoryContract = useFactoryContract() as any
...
export function useSwapCallback(
    ...
    const eip1559 =
        EIP_1559_ACTIVATION_BLOCK[Number(chainId)] === undefined ? false : blockNumber >= EIP_1559_ACTIVATION_BLOCK[Number(chainId)]
    ...
    }, [trade, library, account, chainId, recipient, archerETHTip, archerRelayDeadline, eip1559, recipientAddressOrName, swapCalls, useArcher, addTransaction])
}